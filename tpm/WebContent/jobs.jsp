...
<html>
	...
	<body>
		<form name="jobs" action="jobs" method="get">
			...
			<div class="container">
				<div class="row">
					<div class="col font-weight-bold labelColorOne">Id</div>
					<div class="col font-weight-bold labelColorOne">Customer</div>
					<div class="col font-weight-bold labelColorOne">Date</div>
				</div>		
				<% 
